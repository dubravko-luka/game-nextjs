  ...
  useEffect(() => {
    setSvg(
      <svg id={styles.svg} viewBox="0 0 500 600" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path id='path' d="M27 42V61L27.4902 558.51C27.4956 564.029 31.9711 568.5 37.4901 568.5H463C468.523 568.5 473 564.023 473 558.5V42C473 36.4772 468.523 32 463 32H37C31.4772 32 27 36.4772 27 42Z" fill="black" fill-opacity="0.5" stroke="#FFC700" strokeOpacity="0.5" stroke-width="5" />
