...
const NameInGame: React.FC = () => {
	return (
		<div className={`${stylesComponent.column}`}>
			<p className={`${stylesComponent.titleSetting}`}>Name in game</p>
...
const Sound: React.FC = () => {
	return (
		<div className={`${stylesComponent.column}`}>
			<p className={`${stylesComponent.titleSetting}`}>Sound</p>
			<div className={`${stylesComponent.action}`}>
...
const Language: React.FC = () => {
	return (
		<div className={`${stylesComponent.column}`}>
			<p className={`${stylesComponent.titleSetting}`}>Language</p>
			<div className={`${stylesComponent.action}`}>
...
const Music: React.FC = () => {
	return (
		<div className={`${stylesComponent.column}`}>
			<p className={`${stylesComponent.titleSetting}`}>Music</p>
			<div className={`${stylesComponent.action}`}>
				<div className={`${styles.inputRange}`}>
					<InputRange />
				</div>
